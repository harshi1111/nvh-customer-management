      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="mt-4">
              <span className="text-sm text-blue-600">Across all customers</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-3">
                ...
                <Link
                  to="/customers"
                  className="block w-full py-3 border-2 border-green-600 text-green-600 text-center rounded-lg font-medium hover:bg-green-50 transition-colors"
                >
                  Add New Customer
                </Link>
              </div>
              ...
              {/* Recent Customers */}
              <div className="mt-8">
                <h3 className="font-medium text-gray-700 mb-3">Recent Customers</h3>
                <div className="space-y-3">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 h-full">
              ...
              {recentTransactions.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">Start by adding customers and transactions</p>
                </div>
              ) : (
                      ...
                      {recentTransactions.map(transaction => {
                        ...
                        return (
                          <tr key={transaction.id} className="border-b border-gray-100 last:border-0">
                            ...
                            <td className="py-3">
                              <div className="flex items-center gap-1">
                                <IndianRupee className={`w-4 h-4 ${isDebit ? 'text-red-600' : 'text-green-600'}`} />
                                <span className={`font-medium ${isDebit ? 'text-red-700' : 'text-green-700'}`}>
